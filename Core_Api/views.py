...
class CombinedDataView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        shatyhayanidasa_data =  Shatyhayani_Dasa_Table.objects.all()
        ...
        shatyhayanidasa_serializer = ShatyhayaniDasaSerializer(shatyhayanidasa_data, many=True)
        ...
        combined_data = {
            ...
            'Shatyhayani_Lord_Dasa': shatyhayanidasa_serializer.data,
        }
